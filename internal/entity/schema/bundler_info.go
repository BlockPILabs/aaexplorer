...
func (BundlerInfo) Fields() []ent.Field {
	return []ent.Field{
		...
		field.Int64("gas_collected").StructTag(`json:"gasCollected"`).GoType(decimal.Zero).SchemaType(map[string]string{dialect.Postgres: "numeric(50, 20)"}),
		field.Int64("user_ops_num_d1").StructTag(`json:"userOpsNumD1"`),
		field.Int64("bundles_num_d1").StructTag(`json:"bundlesNumD1"`),
		field.Int64("gas_collected_d1").StructTag(`json:"gasCollectedD1"`).GoType(decimal.Zero).SchemaType(map[string]string{dialect.Postgres: "numeric(50, 20)"}),
		field.Int64("user_ops_num_d7").StructTag(`json:"userOpsNumD7"`),
		field.Int64("bundles_num_d7").StructTag(`json:"bundlesNumD7"`),
		field.Int64("gas_collected_d7").StructTag(`json:"gasCollected_d7"`).GoType(decimal.Zero).SchemaType(map[string]string{dialect.Postgres: "numeric(50, 20)"}),
		field.Int64("user_ops_num_d30").StructTag(`json:"userOpsNumD30"`),
		field.Int64("bundles_num_d30").StructTag(`json:"bundlesNumD30"`),
		field.Int64("gas_collected_d30").StructTag(`json:"gasCollectedD30"`).GoType(decimal.Zero).SchemaType(map[string]string{dialect.Postgres: "numeric(50, 20)"}),
