...
drop trigger if exists transaction_block_sync on block_sync;
drop function if exists transaction_block_sync();
...
drop trigger if exists transaction_receipt_block_sync on block_sync;
drop function if exists  transaction_receipt_block_sync();
...
drop trigger if exists aa_scan_sync on aa_block_sync;
drop function if exists aa_scan_sync;
