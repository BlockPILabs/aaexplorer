...
type BundlerVo struct {
	...
	UserOpsNum int8 `json:"userOpsNum"`
	// BundlesNum holds the value of the "bundles_num" field.
	BundlesNum int8 `json:"bundlesNum"`
	...
	UserOpsNumD1 int8 `json:"userOpsNumD1"`
	// BundlesNumD1 holds the value of the "bundles_num_d1" field.
	BundlesNumD1 int8 `json:"bundlesNumD1"`
	...
	UserOpsNumD7 int8 `json:"userOpsNumD7"`
	// BundlesNumD7 holds the value of the "bundles_num_d7" field.
	BundlesNumD7 int8 `json:"bundlesNumD7"`
	...
	UserOpsNumD30 int8 `json:"userOpsNumD30"`
	// BundlesNumD30 holds the value of the "bundles_num_d30" field.
	BundlesNumD30 int8 `json:"bundlesNumD30"`
