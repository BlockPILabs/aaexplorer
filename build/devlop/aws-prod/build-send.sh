...
#new db
ssh -o StrictHostKeyChecking=no  root@162.55.130.133 mkdir -p /blockpi/aaexplorer/log/ || exit 1
ssh -o StrictHostKeyChecking=no  root@162.55.130.133 mkdir -p ${version_dir} || exit 1
scp -o StrictHostKeyChecking=no  ./dist/aim root@162.55.130.133:"${version_dir}/${version}" || exit 1
